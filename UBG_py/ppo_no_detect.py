...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="Ma_Env_no_detect_city",
...
if __name__ == "__main__":
    ...
    model_save_path = 'outputs/ppo_no_detect_model.pt'
    ...
    for update in range(begin_update, num_updates + 1):
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, demo_batch_size, demo_mini_batch_size):
                ...
                _, newlogprob, entropy, newvalue, newfind = agent.get_action_and_value(demo_obs[mb_inds], demo_game_info[mb_inds],
