...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="Ma_Env_city",
...
if __name__ == "__main__":
    ...
    load_model = True
    model_load_path = 'outputs/model_8_old.pt'
    ...
    pretrain_model_load_path = 'outputs/model_8_old.pt'
    ...
    model_save_path = 'outputs/ppo_ma_city_model.pt'
    ...
    for update in range(begin_update, num_updates + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            time_end1 = time.time()
            print("time cost1: ", time_end1 - time_start1)
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                _, newlogprob, entropy, newvalue, newfind = agent.get_action_and_value(b_obs[mb_inds], b_game_info[mb_inds], b_detect_map[mb_inds],
