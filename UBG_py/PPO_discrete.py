...
class Agent(nn.Module):
    def __init__(self):
        ...
        self.action_mask = torch.zeros(1, env.action_space.n).to(device)
        self.action_mask[0, 0] = 1
        self.action_mask[0, 7] = 1
    ...
    def get_action_and_value(self, x, action=None):
        ...
        logits = logits - self.action_mask * 1e8
...
def parse_args():
    ...
    parser.add_argument("--env-id", type=str, default="Easy_Env-detect",
